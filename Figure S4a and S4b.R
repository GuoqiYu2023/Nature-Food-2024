...
figureS4a<-pheatmap(race_dp_chem, cluster_row = FALSE,cluster_cols = FALSE,border_color = "grey", 
                                     display_numbers = TRUE,        
                                     number_color = "grey40",        
                                     fontsize=10,  angle = 315,               
                                     number_format = "%.2f")            
pdf("figureS4a.pdf", width = 8, height = 14)
print(figureS4a)
dev.off()
...
pdf("figureS4b.pdf", width = 3, height = 14)
print(figureS4b)
dev.off()
